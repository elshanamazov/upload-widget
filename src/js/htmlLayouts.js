...
export function createFileProgressEl(fileName, fileType) {
  ...
  return `
            ...
            <div class="progress__details">
              ...
              <button
                type="button"
                class="progress__btn btn-reset btn-close"
              >
                <svg
                  width="16"
                  height="16"
...
export function createFileProgressUploadedEl(fileName, url = '#') {
  ...
  return `
          <div class="upload__progress progress _uploaded">
          <div class="progress__details">
            <a href="${url}" target="_blank" class="progress__link">
              <span class="progress__name" id="progress-${fileName}">
                ${fileName}
              </span>
            </a>
            <button
              type="button"
              class="btn-reset progress__btn--basket btn-close"
            >
              <svg
                width="8"
                height="8"
              ...
              >
                ...
                />
                <path
                  d="M3.86529 6.89624C3.93252 6.89624 3.99699 6.86951 4.04454 6.82202C4.09209 6.77447 4.11876 6.71 4.11876 6.64276V2.50796C4.11876 2.41737 4.07049 2.33369 3.99205 2.28843C3.91362 2.24311 3.81696 2.24311 3.73852 2.28843C3.66009 2.3337 3.61182 2.41737 3.61182 2.50796V6.64276C3.61182 6.71 3.63848 6.77446 3.68603 6.82202C3.73359 6.86951 3.79805 6.89624 3.86529 6.89624H3.86529Z"
                  fill="#E41D1D"
                />
                <path
                  d="M2.8674 6.89438H2.87817C2.94511 6.89161 3.00819 6.86242 3.0537 6.81324C3.09915 6.76406 3.12334 6.69887 3.12088 6.63193L2.96805 2.49713L2.96811 2.49707C2.96672 2.42935 2.93777 2.36506 2.88787 2.3192C2.83791 2.27339 2.77146 2.24997 2.7038 2.25437C2.63687 2.2572 2.57379 2.28639 2.52834 2.33557C2.48283 2.38475 2.45869 2.44994 2.4611 2.51688L2.61393 6.65168C2.61712 6.71687 2.64517 6.77839 2.69236 6.82353C2.73949 6.86861 2.80215 6.89401 2.8674 6.89437L2.8674 6.89438Z"
                  fill="#E41D1D"
                />
                <path
                  d="M4.85396 6.89439H4.86293C4.92975 6.8959 4.99445 6.8711 5.04321 6.82541C5.0919 6.77966 5.1208 6.71664 5.12362 6.64988L5.27646 2.51507H5.2764C5.27886 2.44814 5.25466 2.38295 5.20922 2.33377C5.16371 2.28459 5.10063 2.2554 5.03369 2.25257C4.96525 2.24553 4.89699 2.26762 4.84565 2.31348C4.79431 2.35929 4.76469 2.42466 4.76403 2.49353L4.60939 6.62833H4.60945C4.60602 6.69617 4.62998 6.76256 4.67597 6.81258C4.7219 6.8626 4.78606 6.8921 4.85396 6.89438L4.85396 6.89439Z"
                  fill="#E41D1D"
                />
              </svg>
            </button>
